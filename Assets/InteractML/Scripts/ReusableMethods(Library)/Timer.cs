...
{
    /// <summary>
    /// Each instance manages a timer (to be called in a loop)
    /// </summary>
    public class Timer
    {
        #region Variables
        ...
        public Timer()
        {
            // When the class instantiates, we set the first state to stopped
            StopTimer();
       ...
       ~Timer()
       {
            // When class is destroyed, make sure to stop timer
            StopTimer();
       }
