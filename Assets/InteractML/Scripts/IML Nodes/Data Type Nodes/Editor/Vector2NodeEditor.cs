...
namespace InteractML.DataTypeNodes
{
    ...
    public class Vector2NodeEditor : IMLNodeEditor
    {
        ...
        public override void OnHeaderGUI()
        {
            ...
            //Display Node name
            GUILayout.Label("LIVE VECTOR2 DATA", Resources.Load<GUISkin>("GUIStyles/InteractMLGUISkin").GetStyle("Header"), GUILayout.MinWidth(NodeWidth - 20), GUILayout.MinHeight(60));
        }
