...
namespace InteractML.FeatureExtractors
{
    ...
    public class ExtractSerialVectorNodeEditor : NodeEditor
    {
        ...
        private void ShowExtractSerialVectorNodePorts()
        {
            ...
            PortField(inputPortLabel, m_ExtractSerialVector.GetInputPort("inputSerialVector"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));

            GUIContent outputPortLabel = new GUIContent("Live Data\n Out");
            PortField(outputPortLabel, m_ExtractSerialVector.GetOutputPort("serialVectorFeatureExtracted"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));
