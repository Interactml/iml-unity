...
namespace InteractML.FeatureExtractors
{
    ...
    public class ExtractVelocityNodeEditor : NodeEditor
    {
        ...
        private void ShowExtractPositionNodePorts()
        {
            ...
            PortField(inputPortLabel, m_ExtractVelocity.GetInputPort("FeatureToInput"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));

            GUIContent outputPortLabel = new GUIContent("Live Data\n Out");
            PortField(outputPortLabel, m_ExtractVelocity.GetOutputPort("VelocityExtracted"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));
