...
namespace InteractML.FeatureExtractors
{
    ...
    public class ExtractVector4NodeEditor : NodeEditor
    {
        ...
        private void ShowExtractVector4NodePorts()
        {
            ...
            IMLNodeEditor.PortField(inputPortLabel, m_ExtractVector4.GetInputPort("inputVector4"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));

            GUIContent outputPortLabel = new GUIContent("Live Data\n Out");
            IMLNodeEditor.PortField(outputPortLabel, m_ExtractVector4.GetOutputPort("vector4FeatureExtracted"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));
