...
namespace InteractML.FeatureExtractors
{
    ...
    public class ExtractVector3NodeEditor : NodeEditor
    {
        ...
        private void ShowExtractVector3NodePorts()
        {
            ...
            PortField(inputPortLabel, m_ExtractVector3.GetInputPort("inputVector3"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));

            GUIContent outputPortLabel = new GUIContent("Live Data\n Out");
            PortField(outputPortLabel, m_ExtractVector3.GetOutputPort("vector3FeatureExtracted"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));
