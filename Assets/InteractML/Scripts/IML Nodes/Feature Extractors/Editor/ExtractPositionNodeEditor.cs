...
namespace InteractML.FeatureExtractors
{
    ...
    public class ExtractPositionNodeEditor : NodeEditor
    {
        ...
        private void ShowExtractPositionNodePorts()
        {
            ...
            PortField(inputPortLabel, m_ExtractPosition.GetInputPort("GameObjectDataIn"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));

            GUIContent outputPortLabel = new GUIContent("Live Data\n Out");
            PortField(outputPortLabel, m_ExtractPosition.GetOutputPort("LiveDataOut"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));
