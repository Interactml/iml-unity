...
namespace InteractML.FeatureExtractors
{
    ...
    public class ExtractIntNodeEditor : NodeEditor
    {
        ...
        private void ShowExtractIntNodePorts()
        {
            ...
            PortField(inputPortLabel, m_ExtractInt.GetInputPort("inputInteger"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));

            GUIContent outputPortLabel = new GUIContent("Live Data\n Out");
            PortField(outputPortLabel, m_ExtractInt.GetOutputPort("integerFeatureExtracted"), skin.GetStyle("Port Label"), GUILayout.MinWidth(0));
