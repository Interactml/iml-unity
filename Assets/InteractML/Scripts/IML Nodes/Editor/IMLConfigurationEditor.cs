...
namespace InteractML
{
    ...
    public class IMLConfigurationEditor : NodeEditor
    {
        ...
        public override void OnBodyGUI()
        {
            ...
            // DEFAULT DRAWING EXCEPT NO DYNAMIC PORTS
            DefaultOnBodyGUINoDynamicPorts();

            // Get reference to imlConfig node
        ...
        private void DefaultOnBodyGUINoDynamicPorts()
        {
#if ODIN_INSPECTOR
            inNodeEditor = true;
#endif
            ...
            // [DISABLED]Iterate through dynamic ports and draw them in the order in which they are serialized
